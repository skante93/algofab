...
if(process.argv[2] && process.argv[2] == "cl-dev"){
	...
	exp.certs = {
	    key: fs.readFileSync(__dirname+'/../certs/'+exp.params.RH_EXT_ADDR+'/privkey.pem', 'utf8'),
	    cert: fs.readFileSync(__dirname+'/../certs/'+exp.params.RH_EXT_ADDR+'/fullchain.pem', 'utf8'),
	    ca :  fs.readFileSync(__dirname+'/../certs/'+exp.params.RH_EXT_ADDR+'/chain.pem', 'utf8')
	}
}
...
console.log(String.raw`
	  ...
	  / / \ \   | |      | | ____ | |  | | | |__    / / \ \   | |_/ /   
	 / /---\ \  | |____  | |__| | | |__| | |  __|  / /---\ \  | |_\ \   
	/_/     \_\ |______| |______| |______| |_|    /_/     \_\ |_____/   RH
