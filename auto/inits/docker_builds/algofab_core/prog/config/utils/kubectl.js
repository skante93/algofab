...
/*
K8S_API=https://$KUBERNETES_SERVICE_HOST:$KUBERNETES_PORT_443_TCP_PORT/api/v1
TKN=$(cat /var/run/secrets/kubernetes.io/serviceaccount/token)

curl -H "Authorization: Bearer $TKN" $K8S_API/namespaces/skante/event?fieldSelector=involvedObject.name=hello,involvedObject.kind=Pod,involvedObject.namespace=skante -k
*/

//console.log("API_TOKEN: "+API_TOKEN);
//console.log("K8S_API: "+K8S_API);

var accepted_kinds = ["secrets", "namespaces", "pods", "services", "replicationcontrollers", "events"];
